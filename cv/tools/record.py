...
if __name__ == "__main__":
  ...
  while True:
    ...
    cv2.putText(img, f"{1/dt:.2f} FPS", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (55, 250, 55), 2)
    cv2.putText(img, f"{'RECORDING' if record else ''}", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 1, (55, 250, 55), 2)

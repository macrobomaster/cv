...
R_CAM = np.array([[-2.89003e-02, -1.32496e-01,  9.90762e-01],
                  [-9.77028e-01,  2.13111e-01, -4.50953e-17],
                  [-2.11142e-01, -9.68002e-01, -1.35612e-01]], dtype=np.float32)
T_CAM = np.array([-0.0515 , -0.01081,  0.     ], dtype=np.float32)

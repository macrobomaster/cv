...
R_CAM = np.array([[ 9.84600e-04, -9.03103e-03,  9.99959e-01],
                  [-9.94109e-01, -1.08382e-01, -5.02004e-17],
                  [ 1.08377e-01, -9.94068e-01, -9.08455e-03]], dtype=np.float32)
T_CAM = np.array([-0.01638, -0.00563,  0.     ], dtype=np.float32)
